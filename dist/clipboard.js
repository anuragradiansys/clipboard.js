...
var Clipboard = /*#__PURE__*/function (_Emitter) {
  ...
  _createClass(Clipboard, [{
    ...
    value: function onClick(e) {
      ...
      $('.clipboard').html('<svg class="h-4 w-4 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M12.973 2.595a3 3 0 00-5.946 0L5 3v1H3.994C2.894 4 2 4.893 2 5.994v12.012C2 19.106 2.893 20 3.994 20h12.012c1.1 0 1.994-.893 1.994-1.994V5.994C18 4.894 17.107 4 16.006 4H15V3l-2.027-.405zM5 6H4v12h12V6h-1v1H5V6zm5-2a1 1 0 100-2 1 1 0 000 2z" fill-rule="evenodd"/></svg>');
